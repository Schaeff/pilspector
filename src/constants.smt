...
(define-fun Arith_BYTE2_BIT19 ((r Int) (v Int)) Bool (and (= r v) (>= v 0) (<= v 589823)))
...
(define-fun Arith_GL_SIGNED_18BITS ((r Int) (v Int)) Bool (and (>= v -262144) (<= v 262144) (exists ((k Int)) (= v (+ -262144 (+ r (* k 524289)))))))
(define-fun Arith_GL_SIGNED_4BITS_C0 ((r Int) (v Int)) Bool (and (>= v -16) (<= v 16) (exists ((k Int)) (= v (+ -16 (+ r (* k 33)))))))
(define-fun Arith_GL_SIGNED_4BITS_C1 ((r Int) (v Int)) Bool (and (>= v -16) (<= v 16) (exists ((k Int)) (= v (+ -16 (+ r (* k 33)))))))
(define-fun Arith_GL_SIGNED_4BITS_C2 ((r Int) (v Int)) Bool (and (>= v -16) (<= v 16) (exists ((k Int)) (= v (+ -16 (+ r (* k 33)))))))
(define-fun Arith_SEL_BYTE2_BIT19 ((r Int) (v Int)) Bool (ite (<= r 65535) (= v 0) (= v 1)))
...
(define-fun Binary_P_A ((r Int) (v Int)) Bool (= v (mod (div r 256) 256)))
(define-fun Binary_P_B ((r Int) (v Int)) Bool (= v (mod r 256)))
; Binary constants are too hard. Since it is out of scope, I'll skip the rest for now.
(define-fun Byte4_SET ((r Int) (v Int)) Bool (= v (mod (+ r 1) 2)))
(define-fun Global_BYTE ((r Int) (v Int)) Bool (and (= r v) (>= v 0) (<= v 255)))
(define-fun Global_BYTE2 ((r Int) (v Int)) Bool (and (= r v) (>= v 0) (<= v 65535)))
(define-fun Global_L1 ((r Int) (v Int)) Bool (= v (ite (= r 0) 1 0)))
; Keccak is too hard, skipping.
(define-fun Main_STEP ((r Int) (v Int)) Bool (= r v))
(define-fun Mem_INCS ((r Int) (v Int)) Bool (= (+ r 1) v ))
(define-fun Mem_ISNOTLAST ((r Int) (v Int)) Bool (= v (ite (= r 2097151) 0 1)))
(define-fun MemAlign_BYTE_C3072 ((r Int) (v Int)) Bool (= v (div r 3072)))
(define-fun MemAlign_BYTE2A ((r Int) (v Int)) Bool (Binary_P_A r v))
(define-fun MemAlign_BYTE2B ((r Int) (v Int)) Bool (Binary_P_B r v))
...
(define-fun MemAlign_OFFSET_func ((r Int)) Int (mod (div r 32) 32))
(define-fun MemAlign_WR8_func ((r Int)) Int (ite (< (mod r 3072) 2048) 0 1))
(define-fun MemAlign_STEP_func ((r Int)) Int (mod r 32))
(define-fun MemAlign_V_BYTE_func ((r Int)) Int (let (
    (wr8 (MemAlign_WR8_func r))
    (step (MemAlign_STEP_func r))
    (offset (MemAlign_OFFSET_func r))
...
(define-fun MemAlign_OFFSET ((r Int) (v Int)) Bool (= v (MemAlign_OFFSET_func r)))
(define-fun MemAlign_RESET ((r Int) (v Int)) Bool (= v (ite (= 0 (mod r 32)) 1 0)))
(define-fun MemAlign_SELM1 ((r Int) (v Int)) Bool (let (
    (wr8 (MemAlign_WR8_func r))
    (step (MemAlign_STEP_func r))
    (offset (MemAlign_OFFSET_func r))
) (= v (ite (ite (= 1 wr8) (= step offset) (> offset step)) 1 0))
))
(define-fun MemAlign_STEP ((r Int) (v Int)) Bool (= v (MemAlign_STEP_func r)))
(define-fun MemAlign_WR8 ((r Int) (v Int)) Bool (= v (MemAlign_WR8_func r)))
(define-fun MemAlign_WR256 ((r Int) (v Int)) Bool (MemAlign_WR8 (+ r 1024) v))

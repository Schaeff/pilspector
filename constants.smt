...
(define-fun MemAlign_FACTOR_0 ((r Int) (v Int)) Bool (= v (ite (= (mod (div r 4) 8) 7) (pow 256 (- 3 (mod r 4))) 0)))
(define-fun MemAlign_FACTOR_n ((n Int) (r Int) (v Int)) Bool (= v (ite (= (mod (div r 4) 8) n) (pow 256 (mod r 4)) 0)))
...
;(define-fun MemAlign_FACTORV_n ((n Int) (r Int) (v Int)) Bool TODO)
(define-fun MemAlign_OFFSET_0 ((r Int) (v Int)) Bool (= v (mod (div r 32) 32)))
(define-fun MemAlign_RESET_0 ((r Int) (v Int)) Bool (= v (ite (= 0 (mod r 32)) 1 0)))
;(define-fun MemAlign_SELM1_0 ((n Int) (r Int) (v Int)) Bool TODO)
(define-fun MemAlign_STEP_0 ((r Int) (v Int)) Bool (= v (mod 32 r)))
(define-fun MemAlign_WR8_0 ((r Int) (v Int)) Bool (= v (ite (< (mod r 3072) 2048) 0 1)))
(define-fun MemAlign_WR256_0 ((r Int) (v Int)) Bool (MemAlign_WR8_0 (+ r 1024) v))

(declare-const x Int)
(assert (MemAlign_WR256_0 3072 x))
(check-sat)
(get-model)
